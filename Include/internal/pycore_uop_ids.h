...
enum {
    ...
    _BINARY_OP_ADD_FLOAT_REUSE_LOCAL_r23,
    ...
    _BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL_r23,
    ...
    _BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL_r23,
    ...
    _BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL_r23,
    _BINARY_SLICE_r31,
