...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [STORE_SUBSCR] = { true, INSTR_FMT_IXC, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [STORE_SUBSCR] = { .nuops = 2, .uops = { { _RECORD_NOS_TYPE, OPARG_SIMPLE, 0 }, { _STORE_SUBSCR, OPARG_SIMPLE, 0 } } },
