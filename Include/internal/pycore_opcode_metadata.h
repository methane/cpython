...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [CALL_ISINSTANCE] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    ...
    [DELETE_ATTR_INSTANCE_VALUE] = { true, INSTR_FMT_IXC000, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    ...
    [LOAD_ATTR_DESCRIPTOR_WITH_VALUES] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    ...
    [LOAD_ATTR_INSTANCE_VALUE_NONDATA] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    ...
    [STORE_ATTR_INLINE_WITH_DICT] = { true, INSTR_FMT_IXC000, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    [STORE_ATTR_INSTANCE_VALUE] = { true, INSTR_FMT_IXC000, HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    [STORE_ATTR_INSTANCE_VALUE_NONDATA] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_ISINSTANCE] = { .nuops = 4, .uops = { { _RECORD_CALL_ARG0_TYPE, OPARG_SIMPLE, 0 }, { _GUARD_THIRD_NULL, OPARG_SIMPLE, 3 }, { _GUARD_CALLABLE_ISINSTANCE, OPARG_SIMPLE, 3 }, { _CALL_ISINSTANCE, OPARG_SIMPLE, 3 } } },
    ...
    [DELETE_ATTR_INSTANCE_VALUE] = { .nuops = 4, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _DELETE_ATTR_INSTANCE_VALUE, 1, 3 }, { _POP_TOP, OPARG_SIMPLE, 4 } } },
    ...
    [LOAD_ATTR_DESCRIPTOR_WITH_VALUES] = { .nuops = 6, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _CHECK_MANAGED_OBJECT_HAS_VALUES, OPARG_SIMPLE, 3 }, { _LOAD_ATTR_DESCRIPTOR, 4, 5 }, { _POP_TOP, OPARG_SIMPLE, 9 }, { _PUSH_NULL_CONDITIONAL, OPARG_SIMPLE, 9 } } },
    ...
    [LOAD_ATTR_INSTANCE_VALUE_NONDATA] = { .nuops = 7, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _CHECK_MANAGED_OBJECT_HAS_VALUES, OPARG_SIMPLE, 3 }, { _LOAD_ATTR_INSTANCE_VALUE_NONDATA, 1, 3 }, { _LOAD_ATTR_INSTANCE_VALUE_NONDATA, OPERAND1_4, 4 }, { _POP_TOP, OPARG_SIMPLE, 8 }, { _PUSH_NULL_CONDITIONAL, OPARG_SIMPLE, 9 } } },
    ...
    [STORE_ATTR_INLINE_WITH_DICT] = { .nuops = 4, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _STORE_ATTR_INLINE_WITH_DICT, 1, 3 }, { _POP_TOP, OPARG_SIMPLE, 4 } } },
    ...
    [STORE_ATTR_INSTANCE_VALUE_NONDATA] = { .nuops = 6, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _GUARD_STORE_ATTR_NONDATA, OPARG_SIMPLE, 3 }, { _GUARD_DORV_NO_DICT, OPARG_SIMPLE, 3 }, { _STORE_ATTR_INSTANCE_VALUE, 1, 3 }, { _POP_TOP, OPARG_SIMPLE, 4 } } },
