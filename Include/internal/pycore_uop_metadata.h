...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_AND_CLEAR_CHECK] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    ...
    [_CHECK_CALL_ACCESS] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_SYNC_SP_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_AND_CLEAR_CHECK] = {
        ...
        .entries = {
            ...
            { 2, 1, _LOAD_FAST_AND_CLEAR_CHECK_r12 },
            { 3, 2, _LOAD_FAST_AND_CLEAR_CHECK_r23 },
            { -1, -1, -1 },
        },
    },
    [_LOAD_FAST_0] = {
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_LOAD_FAST_AND_CLEAR_CHECK_r12] = _LOAD_FAST_AND_CLEAR_CHECK,
    [_LOAD_FAST_AND_CLEAR_CHECK_r23] = _LOAD_FAST_AND_CLEAR_CHECK,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_LOAD_FAST_AND_CLEAR_CHECK_r12] = "_LOAD_FAST_AND_CLEAR_CHECK_r12",
    [_LOAD_FAST_AND_CLEAR_CHECK_r23] = "_LOAD_FAST_AND_CLEAR_CHECK_r23",
