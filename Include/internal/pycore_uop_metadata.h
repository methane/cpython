...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_MAYBE_UNPROTECTED] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_MAYBE_UNPROTECTED] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_AND_CLEAR_CHECK] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_0] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_1] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_2] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_3] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_4] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_5] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_6] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_7] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_0] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_1] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_2] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_3] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_4] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_5] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_6] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_BORROW_7] = HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_END_FOR] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_NO_SAVE_IP_FLAG,
    [_POP_ITER] = HAS_ESCAPES_FLAG,
    [_END_SEND] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_BINARY_OP_SUBSCR_LIST_INT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_BINARY_OP_SUBSCR_TUPLE_INT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_MAKE_HEAP_SAFE] = 0,
    [_RETURN_VALUE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_SYNC_SP_FLAG | HAS_NEEDS_GUARD_IP_FLAG,
    ...
    [_GUARD_YIELD_ACCESS] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_YIELD_VALUE] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_SYNC_SP_FLAG | HAS_NEEDS_GUARD_IP_FLAG,
    ...
    [_CHECK_UNPACK_ACCESS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    ...
    [_CHECK_GLOBAL_ACCESS] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_LOAD_FROM_DICT_OR_DEREF] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_DEREF] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_DEREF] = HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CHECK_ATTR_ACCESS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    ...
    [_CHECK_ITER_ACCESS] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CHECK_CALL_INPUTS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_CALL_KW_INPUTS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_CALL_EX_INPUTS] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_CALL_ACCESS] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_MAYBE_UNPROTECTED] = {
        .best = { 0, 0, 0, 0 },
        .entries = {
            { 1, 0, _LOAD_FAST_MAYBE_UNPROTECTED_r01 },
            { -1, -1, -1 },
            { -1, -1, -1 },
            { -1, -1, -1 },
        },
    },
    [_LOAD_FAST_BORROW_MAYBE_UNPROTECTED] = {
        .best = { 0, 0, 0, 0 },
        .entries = {
            { 1, 0, _LOAD_FAST_BORROW_MAYBE_UNPROTECTED_r01 },
            { -1, -1, -1 },
            { -1, -1, -1 },
            { -1, -1, -1 },
        },
    },
    [_LOAD_FAST_AND_CLEAR_CHECK] = {
        .best = { 0, 0, 0, 0 },
        .entries = {
            { 1, 0, _LOAD_FAST_AND_CLEAR_CHECK_r01 },
            { -1, -1, -1 },
            { -1, -1, -1 },
            { -1, -1, -1 },
        },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_LOAD_FAST_MAYBE_UNPROTECTED_r01] = _LOAD_FAST_MAYBE_UNPROTECTED,
    [_LOAD_FAST_BORROW_MAYBE_UNPROTECTED_r01] = _LOAD_FAST_BORROW_MAYBE_UNPROTECTED,
    [_LOAD_FAST_AND_CLEAR_CHECK_r01] = _LOAD_FAST_AND_CLEAR_CHECK,
    ...
    [_GUARD_YIELD_ACCESS_r11] = _GUARD_YIELD_ACCESS,
    ...
    [_CHECK_GLOBAL_ACCESS_r11] = _CHECK_GLOBAL_ACCESS,
    ...
    [_CHECK_ATTR_ACCESS_r00] = _CHECK_ATTR_ACCESS,
    ...
    [_CHECK_ITER_ACCESS_r11] = _CHECK_ITER_ACCESS,
    ...
    [_CHECK_CALL_INPUTS_r00] = _CHECK_CALL_INPUTS,
    [_CHECK_CALL_KW_INPUTS_r11] = _CHECK_CALL_KW_INPUTS,
    [_CHECK_CALL_EX_INPUTS_r33] = _CHECK_CALL_EX_INPUTS,
    [_CHECK_CALL_ACCESS_r11] = _CHECK_CALL_ACCESS,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_CHECK_ATTR_ACCESS] = "_CHECK_ATTR_ACCESS",
    [_CHECK_ATTR_ACCESS_r00] = "_CHECK_ATTR_ACCESS_r00",
    ...
    [_CHECK_CALL_ACCESS] = "_CHECK_CALL_ACCESS",
    [_CHECK_CALL_ACCESS_r11] = "_CHECK_CALL_ACCESS_r11",
    ...
    [_CHECK_CALL_EX_INPUTS] = "_CHECK_CALL_EX_INPUTS",
    [_CHECK_CALL_EX_INPUTS_r33] = "_CHECK_CALL_EX_INPUTS_r33",
    [_CHECK_CALL_INPUTS] = "_CHECK_CALL_INPUTS",
    ...
    [_CHECK_GLOBAL_ACCESS] = "_CHECK_GLOBAL_ACCESS",
    [_CHECK_GLOBAL_ACCESS_r11] = "_CHECK_GLOBAL_ACCESS_r11",
    ...
    [_CHECK_ITER_ACCESS] = "_CHECK_ITER_ACCESS",
    [_CHECK_ITER_ACCESS_r11] = "_CHECK_ITER_ACCESS_r11",
    ...
    [_GUARD_YIELD_ACCESS] = "_GUARD_YIELD_ACCESS",
    [_GUARD_YIELD_ACCESS_r11] = "_GUARD_YIELD_ACCESS_r11",
    ...
    [_LOAD_FAST_AND_CLEAR_CHECK] = "_LOAD_FAST_AND_CLEAR_CHECK",
    [_LOAD_FAST_AND_CLEAR_CHECK_r01] = "_LOAD_FAST_AND_CLEAR_CHECK_r01",
    ...
    [_LOAD_FAST_BORROW_MAYBE_UNPROTECTED] = "_LOAD_FAST_BORROW_MAYBE_UNPROTECTED",
    [_LOAD_FAST_BORROW_MAYBE_UNPROTECTED_r01] = "_LOAD_FAST_BORROW_MAYBE_UNPROTECTED_r01",
    [_LOAD_FAST_CHECK] = "_LOAD_FAST_CHECK",
    [_LOAD_FAST_CHECK_r01] = "_LOAD_FAST_CHECK_r01",
    [_LOAD_FAST_MAYBE_UNPROTECTED] = "_LOAD_FAST_MAYBE_UNPROTECTED",
    [_LOAD_FAST_MAYBE_UNPROTECTED_r01] = "_LOAD_FAST_MAYBE_UNPROTECTED_r01",
