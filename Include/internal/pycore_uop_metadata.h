...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_UNARY_NEGATIVE_FLOAT_INPLACE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_UNARY_NOT] = 0,
    ...
    [_BINARY_OP_ADD_FLOAT_INPLACE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT_INPLACE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_INPLACE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_ADD_FLOAT_INPLACE_RIGHT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_INPLACE_RIGHT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT_INPLACE_RIGHT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_ADD_FLOAT_REUSE_LOCAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_BINARY_OP_SUBSCR_USTR_INT] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_NOS_TUPLE] = HAS_EXIT_FLAG,
    [_GUARD_TOS_TUPLE] = HAS_EXIT_FLAG,
    [_GUARD_BINARY_OP_SUBSCR_TUPLE_INT_BOUNDS] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT_REUSE_LOCAL] = {
        .best = { 2, 2, 2, 2 },
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 3, 2, _BINARY_OP_ADD_FLOAT_REUSE_LOCAL_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL] = {
        .best = { 2, 2, 2, 2 },
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 3, 2, _BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL] = {
        .best = { 2, 2, 2, 2 },
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 3, 2, _BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL] = {
        .best = { 2, 2, 2, 2 },
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 3, 2, _BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL_r23 },
            { -1, -1, -1 },
        },
    },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT_REUSE_LOCAL_r23] = _BINARY_OP_ADD_FLOAT_REUSE_LOCAL,
    [_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL_r23] = _BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL,
    [_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL_r23] = _BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL,
    [_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL_r23] = _BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT_REUSE_LOCAL] = "_BINARY_OP_ADD_FLOAT_REUSE_LOCAL",
    [_BINARY_OP_ADD_FLOAT_REUSE_LOCAL_r23] = "_BINARY_OP_ADD_FLOAT_REUSE_LOCAL_r23",
    ...
    [_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL] = "_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL",
    [_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL_r23] = "_BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL_r23",
    ...
    [_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL] = "_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL",
    [_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL_r23] = "_BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL_r23",
    ...
    [_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL] = "_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL",
    [_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL_r23] = "_BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL_r23",
...
int _PyUop_num_popped(int opcode, int oparg)
{
    switch(opcode) {
        ...
        case _BINARY_OP_SUBTRACT_FLOAT_INPLACE_RIGHT:
            return 2;
        case _BINARY_OP_ADD_FLOAT_REUSE_LOCAL:
            return 2;
        case _BINARY_OP_SUBTRACT_FLOAT_REUSE_LOCAL:
            return 2;
        case _BINARY_OP_MULTIPLY_FLOAT_REUSE_LOCAL:
            return 2;
        case _BINARY_OP_TRUEDIV_FLOAT_REUSE_LOCAL:
            return 2;
