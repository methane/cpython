...
const _PyOpcodeRecordEntry _PyOpcode_RecordEntries[256] = {
        ...
        [LOAD_ATTR_INSTANCE_VALUE_NONDATA] = {1, {_RECORD_TOS_INDEX}},
        ...
        [STORE_ATTR_INSTANCE_VALUE_NONDATA] = {1, {_RECORD_TOS_TYPE_INDEX}},
        [DELETE_ATTR_INSTANCE_VALUE] = {1, {_RECORD_TOS_TYPE_INDEX}},
        [STORE_ATTR_INLINE_WITH_DICT] = {1, {_RECORD_TOS_TYPE_INDEX}},
...
const _PyOpcodeRecordSlotMap _PyOpcode_RecordSlotMaps[256] = {
        ...
        [LOAD_ATTR_INSTANCE_VALUE_NONDATA] = {1, 1, {0}},
        ...
        [STORE_ATTR_INSTANCE_VALUE_NONDATA] = {1, 0, {0}},
        [DELETE_ATTR_INSTANCE_VALUE] = {1, 0, {0}},
        [STORE_ATTR_INLINE_WITH_DICT] = {1, 0, {0}},
        ...
        [LOAD_ATTR_DESCRIPTOR_WITH_VALUES] = {1, 1, {0}},
