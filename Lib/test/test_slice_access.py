"""Access checks at the public slice C API boundaries."""
...
class SliceAccessTests(unittest.TestCase):
    @threading_helper.requires_working_threading()
    def test_foreign_slice(self):
        ...
        foreign = slice(1, 4, 2)
        apis = (
            (capi.PySlice_Unpack, (foreign,)),
            (capi.PySlice_GetIndices, (foreign, 10)),
        )
