"""Access checks at the public memoryview C API boundaries."""
...
class MemoryViewAccessTests(unittest.TestCase):
    @threading_helper.requires_working_threading()
    def test_foreign_buffer_object(self):
        ...
        class LocalBytearray(bytearray):
            pass

        value = LocalBytearray(b"foreign")
        apis = (
            (capi.memoryview_fromobject, (value,)),
            (capi.memoryview_getcontiguous, (value,)),
        )
