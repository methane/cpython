...
_specialized_opmap = frozendict(
    ...
    CONTAINS_OP_SET=173,
    DELETE_ATTR_INSTANCE_VALUE=174,
    FOR_ITER_GEN=175,
    FOR_ITER_LIST=176,
    FOR_ITER_RANGE=177,
    FOR_ITER_TUPLE=178,
    ...
    LOAD_ATTR_DESCRIPTOR_WITH_VALUES=186,
    LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN=187,
    LOAD_ATTR_INSTANCE_VALUE=188,
    LOAD_ATTR_INSTANCE_VALUE_NONDATA=189,
    ...
    SEND_GEN=206,
    SEND_VIRTUAL=207,
    STORE_ATTR_INLINE_WITH_DICT=208,
    STORE_ATTR_INSTANCE_VALUE=209,
    STORE_ATTR_INSTANCE_VALUE_NONDATA=210,
    STORE_ATTR_SLOT=211,
