...
bool _mi_free_delayed_block(mi_block_t* block) {
  ...
  // PyThreadState_Clear can exclusively drain an inactive thread's heaps.
  // The caller checks that lifecycle condition; OS thread identity and the
  // interpreter GIL do not describe ownership during this cleanup.
