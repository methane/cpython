...
NON_ESCAPING_FUNCTIONS = (
    ...
    # Empty dictionary allocation schedules GC without invoking Python.
    "PyDict_New",
    "PyUnicode_READ_CHAR",
    ...
    "_PyJit_CanBindInitExactly",
    "_PyJit_PushSimpleFrame",
    "_PyJit_CanCloseNoEscape",
    "_PyJit_CanClosePrimitive",
    "_PyJit_UnpackLocalsUnchanged",
    "_PyJit_RecordMethodFallback",
    "_PyJit_CanDecRefNoEscape",
    "_PyJit_StoreAttributeNoEscape",
    "_PyJit_NewEmptySet",
    "_PyJit_CloseNoEscape",
    ...
    # Allocation schedules GC; transferring stack references cannot call Python.
    ...
    "_PyRegion_NumberAttribute",
    "_PyRegion_NumberAsDouble",
    "_PyRegion_IntInput",
    "_PyRegion_SequenceContainsInt",
    "_PyRegion_Length",
    "_PyRegion_AsInt64",
    "_PyRegion_Arithmetic",
